<template>
    <div class="record-notes-detail">
        <h3 class="record-notes-detail__title">Эффективность: Пятков Константин</h3>
        ...
        <div class="efficiency-stats">
            ...
            <div class="efficiency-stats__in-progress">
                ...
                <p class="efficiency-stats__in-progress-value">3</p>
            </div>
            <div class="efficiency-stats__completed">
                <h3 class="efficiency-stats__completed-title">Завершено</h3>
                <p class="efficiency-stats__completed-value">2</p>
            </div>
