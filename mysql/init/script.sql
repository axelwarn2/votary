...
CREATE TABLE `Employee` (
  ...
  `role` enum('руководитель','исполнитель') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'роль (руководитель/исполнитель)',
  PRIMARY KEY (`id`)
...
CREATE TABLE `Task` (
  ...
  `description` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'описание задачи',
